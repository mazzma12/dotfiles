...
;
(gtk_accel_path "<Actions>/terminal-window/goto-tab-1" "<Ctl>1")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-3" "<Ctl>3")
...
(gtk_accel_path "<Actions>/terminal-window/fullscreen" "<Primary><Shift>f")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-6" "<Ctl>6")
; (gtk_accel_path "<Actions>/terminal-window/read-only" "")
; (gtk_accel_path "<Actions>/terminal-window/detach-tab" "<Primary><Shift>d")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-8" "<Ctl>8")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-2" "<Ctl>2")
; (gtk_accel_path "<Actions>/terminal-window/scroll-on-output" "")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-5" "<Ctl>5")
