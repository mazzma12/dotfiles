...
## Supply SSL options for the o HTTPServer. See the o docs for
#  details.
...
#  uses.
c.NotebookApp.tornado_settings = {'max_body_size': 104857600, 'max_buffer_size': 104857600}
...
import sys, os
if os.path.isfile("/home/mazzo/.julia/packages/WebIO/Rk8wc/deps/jlstaticserve.py"):
    sys.path.append("/home/mazzo/.julia/packages/WebIO/Rk8wc/deps")
    c = get_config()
    c.NotebookApp.nbserver_extensions = {
        "jlstaticserve": True
    }
