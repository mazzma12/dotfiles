...
#         highlighting:
#  algol_nu, rainbow_dash, vs, paraiso-dark, monokai, algol, pastie, igor, arduino, abap, lovelace, emacs, paraiso-light, autumn, trac, native, tango, bw, fruity, default, colorful, murphy, borland, rrt, manni, xcode, friendly, perldoc, vim
